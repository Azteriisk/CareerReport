...
export function CompanyProfileClient({ slug }: { slug: string }) {
            ...
            <div>
              ...
              {jobs.length === 0 ? (
                <div style={{ background: 'var(--surface-color)', border: '1px dashed var(--glass-border)', padding: 'clamp(2rem, 5vw, 4rem) clamp(1rem, 5vw, 2rem)', borderRadius: '16px', textAlign: 'center' }}>
                  <Briefcase size={48} color="var(--text-secondary)" opacity={0.3} style={{ marginBottom: '1.5rem' }} />
                  <h3 style={{ color: 'var(--text-primary)', margin: '0 0 0.5rem 0' }}>No Jobs Listed</h3>
